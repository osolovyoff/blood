...
function(configuration_linking_flags)
	...
	if (UNIX)
		if(RASPBERRY)
			set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fpermissive -std=c++11 -fPIC" PARENT_SCOPE)
			set(CMAKE_EXE_LINKER_FLAGS "-static -mcpu=cortex-a7 -march=armv6 -mfloat-abi=hard -mfpu=vfp -lm" PARENT_SCOPE)
